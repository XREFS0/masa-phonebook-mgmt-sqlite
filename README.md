# Address Book & Contact Management Platform

High-performance desktop contact book for storing, editing, searching, and exporting personal and business contact directories via SQLite.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-phonebook-mgmt-sqlite.git
   cd masa-phonebook-mgmt-sqlite
   ```
